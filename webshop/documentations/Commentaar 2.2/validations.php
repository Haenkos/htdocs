<?php
    ...
    function validateContactForm() {
        ...
        $data = array(
            "gender" /* JH TIP: Omdat je deze strings veel gebruikt, kan je hier ook defines van maken define("GENDER", "gender") en dan kan je overal GENDER gebruiken waar nu "gender" staat */ => "",
            "name" => "",
            "email" => "",
            "phone" => "",
            "compref" => "",
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          /* JH TIP: In plaats van overal $_POST te gebruiken kan je ook doen $data['gender'] = formatInput(getPostVar("gender")); */
          ...
          /* JH TIP: In plaats van overal $_POST te gebruiken kan je ook doen $data['name'] = formatInput(getPostVar("name")); en dan if (empty($data['name'])) $data['name']) { ... }*/
          if (isset($_POST["name"])) {
            ...
            /* JH TIP: De code hieronder wordt ook gebruikt op regel  104 en 152, misschien kan je er een functie van maken iets als $data = validateEmail("email", $data); */

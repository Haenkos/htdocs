<?php
    require_once 'contact.php'; /* JH: Deze is nodig omdat je de defines in contact heb staan, ik zou de defines in een separate php file zetten en die hier en in contact.php includen */
